      ...
      <div className="container">
        <div className="contact-grid">
          ...
          <div className="contact-info-card">
            <div>
              <h3 style={{ fontSize: '1.5rem', color: '#fff', marginBottom: '24px' }}>{t.addressTitle}</h3>
              ...
              <div className="info-item">
                ...
                <div>
                  <strong style={{ display: 'block', fontSize: '1rem', marginBottom: '4px' }}>Johannesburg Genel Merkez</strong>
                  <span style={{ fontSize: '0.95rem', opacity: 0.9, lineHeight: '1.6' }}>
                    20 Goring Avenue Aucklandpark, Johannesburg, South Africa
                  </span>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div>
                  <strong style={{ display: 'block', fontSize: '1rem', marginBottom: '4px' }}>{t.phoneTitle}</strong>
                  <a href="tel:+27818216936" style={{ fontSize: '1.1rem', color: 'var(--secondary)', fontWeight: 800 }}>
                    +27 81 821 6936
                  </a>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div>
                  <strong style={{ display: 'block', fontSize: '1rem', marginBottom: '4px' }}>{t.emailTitle}</strong>
                  <a href="mailto:info@anvtrust.org" style={{ fontSize: '0.95rem', opacity: 0.9 }}>
                    info@anvtrust.org
                  </a>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div>
                  <strong style={{ display: 'block', fontSize: '1rem', marginBottom: '4px' }}>Çalışma Saatleri</strong>
                  <span style={{ fontSize: '0.9rem', opacity: 0.85 }}>
                    Pazartesi - Cuma: 09:00 - 17:00 (SAST)
                  </span>
                </div>
              </div>
            </div>

            <div style={{ paddingTop: '24px', borderTop: '1px solid var(--dark-surface)' }}>
